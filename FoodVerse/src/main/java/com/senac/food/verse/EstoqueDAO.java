...
public class EstoqueDAO {
    ...
    public List<String> categoriasNomes() {
        return CATEGORIAS.stream().map(CategoriaEstoque::getNome).toList();
    }

    public List<Unidade> listarUnidades() { return new ArrayList<>(UNIDADES.values()); }
    ...
    public List<ItemEstoque> listarItens(String termo, String categoria, String status) {
        ...
        boolean filtraCat = categoria != null && !categoria.equalsIgnoreCase("Todas");
