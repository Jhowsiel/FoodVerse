# Generated by Django 6.0.3 on 2026-03-17 19:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restricoes', models.CharField(blank=True, max_length=255, null=True)),
                ('data_criacao', models.DateTimeField(blank=True, null=True)),
                ('tipo_produto', models.CharField(blank=True, default='VENDA', max_length=20, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_produto_pedido', models.AutoField(primary_key=True, serialize=False)),
                ('quantidade', models.IntegerField(db_column='quantidade')),
                ('pedido', models.ForeignKey(db_column='ID_pedido', on_delete=django.db.models.deletion.DO_NOTHING, to='foodverse.tbpedidos')),
                ('produto', models.ForeignKey(db_column='ID_produto', on_delete=django.db.models.deletion.DO_NOTHING, to='foodverse.tbprodutos')),
            ],
            options={
